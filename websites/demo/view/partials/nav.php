        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/PHP/websites/demo/" 
   class="<?= $_SERVER['REQUEST_URI'] === '/PHP/websites/demo/' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">
   Home
</a>

<a href="/PHP/websites/demo/about.php" 
   class="<?= $_SERVER['REQUEST_URI'] === '/PHP/websites/demo/about.php' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">
   About
</a>

<a href="/PHP/websites/demo/contact.php" 
   class="<?= $_SERVER['REQUEST_URI'] === '/PHP/websites/demo/contact.php' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">
   Contact
</a>
